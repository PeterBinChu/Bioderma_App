...
public class Product {
    ...
    public Product(String nameProduct, String category, String description, String nativeKeyProduct, int price, String image, int quantity1) {
    ...
    public String getQuantityString(){return String.valueOf(quantity);}
